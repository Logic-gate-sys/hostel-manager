...
export const NavBar = () => {
  return (
    <nav className="bg-[#152259] h-screen box-shadow-2xl font-semi-bold text-sm flex flex-col p-1">
      {/* -------------------- Logo & Name ------------------------------------ */}
      <div
        id="logo-container"
        ...
        >
          <div className="flex items-center gap-2" >
            <svg xmlns="http://www.w3.org/2000/svg"
              ...
              width="24px"
              fill="white">
              <path d="M520-600v-240h320v240H520ZM120-440v-400h320v400H120Zm400 320v-400h320v400H520Zm-400
             0v-240h320v240H120Zm80-400h160v-240H200v240Zm400 320h160v-240H600v240Zm0-480h160v-80H600v80ZM200-200h160v-80H200v80Zm160-320Zm240-160Zm0 240ZM360-280Z"/></svg>
        ...
        >
          <div className="flex items-center gap-2">
            <svg
              ...
              width="24px"
              fill="white">
              <path d="m370-80-16-128q-13-5-24.5-12T307-235l-119 50L78-375l103-78q-1-7-1-13.5v-27q0-6.5 1-13.5L78-585l110-190 
        ...
        >
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg"
              ...
              width="24px"
              fill="white">
              <path d="M478-240q21 0 35.5-14.5T528-290q0-21-14.5-35.5T478-340q-21 0-35.5 14.5T428-290q0 21 14.5 35.5T478-240Zm-36-154h74q0-33
