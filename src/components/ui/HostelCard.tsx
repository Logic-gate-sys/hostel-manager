...
export const HostelCard = () => {
  return (
    ...
    >
      <div id="card-image">
        <img src={hostel[0].image} alt="Hostel Image" height={162} width={282} className="rounded-xl " />
      </div>

      <div id="card-texts" className="mt-3 flex flex-col gap-2">
      ...
      <div id="locations-hostel" className="mt-1 flex ">
        ...
        <p className="ml-auto flex gap-1"> 
          {hostel[0].likes} <img src={likes} height={15} width={15} alt="Likes" />{" "}
        </p>
        </div>
        </div>
    </div>
